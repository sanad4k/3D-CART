...
const CardList = () => {
  ...
  const cards = [
    ...
    { id: 6, src: '/photos/6.png', name: 'Astronaut', category: 'RIG', artist: 'Hasbulla', price: 200, description: 'A high-quality texture for 3D rendering.' },
    { id: 7, src: '/photos/7.png', name: 'future room', category: '3D', artist: 'Jerry', price: 200, description: 'A high 3D rendering.' },
    { id: 8, src: '/photos/8.png', name: 'Walter White', category: 'RIG', artist: 'Jim', price: 200, description: 'A high 3D rendering.' },
    ...
    { id: 10, src: '/photos/10.png', name: 'JINX', category: 'RIG', artist: 'Sayed Mohamed', price: 200, description: 'A high qulaity 3D rendering.' },
